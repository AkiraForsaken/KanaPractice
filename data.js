...
const KATAKANA = {
  basic: [
    ...
    { char: 'ン', romaji: 'n', group: 'w' },
  ],

  dakuten: [
    // G-row
    { char: 'ガ', romaji: 'ga', group: 'g' },
    { char: 'ギ', romaji: 'gi', group: 'g' },
    { char: 'グ', romaji: 'gu', group: 'g' },
    { char: 'ゲ', romaji: 'ge', group: 'g' },
    { char: 'ゴ', romaji: 'go', group: 'g' },
    // Z-row
    { char: 'ザ', romaji: 'za', group: 'z' },
    { char: 'ジ', romaji: 'ji', group: 'z' },
    { char: 'ズ', romaji: 'zu', group: 'z' },
    { char: 'ゼ', romaji: 'ze', group: 'z' },
    { char: 'ゾ', romaji: 'zo', group: 'z' },
    // D-row
    { char: 'ダ', romaji: 'da', group: 'd' },
    { char: 'ヂ', romaji: 'ji', group: 'd' },
    { char: 'ヅ', romaji: 'zu', group: 'd' },
    { char: 'デ', romaji: 'de', group: 'd' },
    { char: 'ド', romaji: 'do', group: 'd' },
    // B-row
    { char: 'バ', romaji: 'ba', group: 'b' },
    { char: 'ビ', romaji: 'bi', group: 'b' },
    { char: 'ブ', romaji: 'bu', group: 'b' },
    { char: 'ベ', romaji: 'be', group: 'b' },
    { char: 'ボ', romaji: 'bo', group: 'b' },
    // P-row (handakuten)
    { char: 'パ', romaji: 'pa', group: 'p' },
    { char: 'ピ', romaji: 'pi', group: 'p' },
    { char: 'プ', romaji: 'pu', group: 'p' },
    { char: 'ペ', romaji: 'pe', group: 'p' },
    { char: 'ポ', romaji: 'po', group: 'p' },
  ],

  combo: [
    { char: 'キャ', romaji: 'kya', group: 'combo-k' },
    { char: 'キュ', romaji: 'kyu', group: 'combo-k' },
    { char: 'キョ', romaji: 'kyo', group: 'combo-k' },
    { char: 'シャ', romaji: 'sha', group: 'combo-s' },
    { char: 'シュ', romaji: 'shu', group: 'combo-s' },
    { char: 'ショ', romaji: 'sho', group: 'combo-s' },
    { char: 'チャ', romaji: 'cha', group: 'combo-t' },
    { char: 'チュ', romaji: 'chu', group: 'combo-t' },
    { char: 'チョ', romaji: 'cho', group: 'combo-t' },
    { char: 'ニャ', romaji: 'nya', group: 'combo-n' },
    { char: 'ニュ', romaji: 'nyu', group: 'combo-n' },
    { char: 'ニョ', romaji: 'nyo', group: 'combo-n' },
    { char: 'ヒャ', romaji: 'hya', group: 'combo-h' },
    { char: 'ヒュ', romaji: 'hyu', group: 'combo-h' },
    { char: 'ヒョ', romaji: 'hyo', group: 'combo-h' },
    { char: 'ミャ', romaji: 'mya', group: 'combo-m' },
    { char: 'ミュ', romaji: 'myu', group: 'combo-m' },
    { char: 'ミョ', romaji: 'myo', group: 'combo-m' },
    { char: 'リャ', romaji: 'rya', group: 'combo-r' },
    { char: 'リュ', romaji: 'ryu', group: 'combo-r' },
    { char: 'リョ', romaji: 'ryo', group: 'combo-r' },
    { char: 'ギャ', romaji: 'gya', group: 'combo-g' },
    { char: 'ギュ', romaji: 'gyu', group: 'combo-g' },
    { char: 'ギョ', romaji: 'gyo', group: 'combo-g' },
    { char: 'ジャ', romaji: 'ja', group: 'combo-j' },
    { char: 'ジュ', romaji: 'ju', group: 'combo-j' },
    { char: 'ジョ', romaji: 'jo', group: 'combo-j' },
    { char: 'ビャ', romaji: 'bya', group: 'combo-b' },
    { char: 'ビュ', romaji: 'byu', group: 'combo-b' },
    { char: 'ビョ', romaji: 'byo', group: 'combo-b' },
    { char: 'ピャ', romaji: 'pya', group: 'combo-p' },
    { char: 'ピュ', romaji: 'pyu', group: 'combo-p' },
    { char: 'ピョ', romaji: 'pyo', group: 'combo-p' },
  ],
};

KATAKANA.all = [...KATAKANA.basic, ...KATAKANA.dakuten, ...KATAKANA.combo];
